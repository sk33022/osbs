                ...
                <div class="panel-heading display-table">
                    <div class="row display-tr">
                        ...
                        <div class="display-td">
                            <img class="img-responsive pull-right" src="{{ asset('logo/images.png')}}" width="60"
                                 height="30">
                        </div>
                    </div>
                </div>
...
{{--                                @if({{$duration}} == 1){--}}
                                    <input class='form-control' size='4' type='text' value="{{$duration}}" readonly>
                            </div>
                        </div>
