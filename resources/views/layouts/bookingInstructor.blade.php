    ...
    <div class="container">
        <div class="container1">
            <div class="row ">
                <div class="col-md-5">
                    <div class="card">
                        <div class="card-header">{{ __('Instructor Booking section') }}</div>
                        <div class="card-body">
                            @if (session('status'))
                            ...
                            <form action="{{route('instructorBook')}}" method="post">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" id="date" name="date" min="{{ now()->toDateString('Y-m-d') }}">                                </div>
