...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-header">
            <h2 class="card-title">Popular Instructor</h2>
        </div>
        ...
        <div class="card-body">
            <div id="example1_wrapper" class="dataTables_wrapper dt-bootstrap4">
                ...
                <div class="col-sm-12"><table id="example1" class="table table-bordered table-striped dataTable dtr-inline" role="grid" aria-describedby="example1_info">
                        <thead>
                        <tr role="row">
                            <th class="sorting sorting_asc" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Payment_ID: activate to sort column descending">Instructor_ID</th>
                            <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Payer_ID: activate to sort column ascending">Hired Times</th>
                        ...
                        @foreach($instructor_book as $data)
                            <tr class="odd">
                                <td class="dtr-control sorting_1" tabindex="0">{{$data->instructor_id}}</td>
                                <td>{{$data->qty}}</td>
                        ...
                        <tfoot>
                        <th rowspan="1" colspan="1">Total Hiring Performed-</th>
