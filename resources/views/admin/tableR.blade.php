...
@section('content')
    ...
    <div class="card-header">
        <h2 class="card-title">Revenue from Instructor Hiring</h2>
    </div>
    ...
    <div class="card">
        ...
        {{--            <div class="card-body">--}}
        <!-- Date -->
            <form action="/dateReport1" method="post">
            ...
            <div id="example1_wrapper" class="dataTables_wrapper dt-bootstrap4">
                ...
                <div class="col-sm-12"><table id="example1" class="table table-bordered table-striped dataTable dtr-inline" role="grid" aria-describedby="example1_info">
                        ...
                        <tr role="row">
                            ...
                            <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Hiring_ID: activate to sort column ascending">Hiring_ID</th>
                        ...
                        <tfoot>
                        <th rowspan="1" colspan="4">Total Revenue From Instructor Hiring</th>
