    ...
    <div class="card-body">
        <div id="example1_wrapper" class="dataTables_wrapper dt-bootstrap4">
            ...
            <div class="col-sm-12"><table id="example1" class="table table-bordered table-striped dataTable dtr-inline" role="grid" aria-describedby="example1_info">
                    <thead>
                    <tr role="row">
                        <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="User_ID: activate to sort column ascending">User ID</th>
                        <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Booking_Times: activate to sort column ascending">Booking Times</th>
                    </thead>
                    <tbody>
...
{{--                            <td class="dtr-control sorting_1" tabindex="0">{{$data->id}}</td>--}}
                    ...
                    <tfoot>
                    <th rowspan="1" colspan="1">Total Booking From Swimming Pool</th>
